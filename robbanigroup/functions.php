...
if(!function_exists('ketoki_header_scripts')):
    function ketoki_header_scripts(){ 
       ...
       wp_enqueue_style('font-awsome', get_template_directory_uri().'/css/font-awesome.css');
        wp_enqueue_style('ketoki-style', get_stylesheet_uri() );
       ...
       wp_enqueue_style('dl-menu', get_template_directory_uri().'/css/dl-menu.css');
       wp_enqueue_style('flex', get_template_directory_uri().'/css/flexslider.css');
       wp_enqueue_style('pretty', get_template_directory_uri().'/css/prettyphoto.css');
...
if(!function_exists('ketoki_footer_scripts') ):
    function ketoki_footer_scripts(){ 
        wp_enqueue_script('jsmin', get_template_directory_uri().'/script/jquery.min.js');
        wp_enqueue_script('modern', get_template_directory_uri().'/script/modernizr.js');
        wp_enqueue_script('bootjs', get_template_directory_uri().'/script/bootstrap.min.js');
        wp_enqueue_script('menujss', get_template_directory_uri().'/script/jquery.dlmenu.js');
        wp_enqueue_script('flexjs', get_template_directory_uri().'/script/flexslider-min.js');
        wp_enqueue_script('countjs', get_template_directory_uri().'/script/jquery.countdown.min.js');
        wp_enqueue_script('pretyjs', get_template_directory_uri().'/script/jquery.prettyphoto.js');
        wp_enqueue_script('wayponint', get_template_directory_uri().'/script/waypoints-min.js');
        wp_enqueue_script('oulcaro', get_template_directory_uri().'/script/owl.carousel.min.js');
        wp_enqueue_script('cutome', get_template_directory_uri().'/script/custom.js');
        wp_enqueue_script('isotop', get_template_directory_uri().'/script/isotope.min.js');
        wp_enqueue_script('fitdiv', get_template_directory_uri().'/script/fitvideo.js');
        wp_enqueue_script('bootdatetime', get_template_directory_uri().'/script/bootstrap-datetimepicker.min.js');
        wp_enqueue_script('fun', get_template_directory_uri().'/script/functions.js');
    }
